...
export default function PickupMap() {
  ...
  return (
    <div className="p-6">
      ...
      <p className="mb-4 text-sm text-muted-foreground">Map for scheduling and assigning pickups.</p>
      <LeafletMap markers={markers} height="60vh" showCircle={{ center: [3.8465, 11.5045], radius: 400 }} />
    </div>
  );
}

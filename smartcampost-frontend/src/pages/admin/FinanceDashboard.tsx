...
import { DollarSign, TrendingUp, RefreshCw, CreditCard, ArrowUp, ArrowDown, Download } from 'lucide-react';
...
export default function FinanceDashboard() {
  ...
  const recentTransactions = [
    { id: '1', type: 'Payment', amount: 150.00, status: 'Completed', customer: 'John Doe', date: '2026-01-10' },
    { id: '2', type: 'Refund', amount: -45.00, status: 'Processing', customer: 'Jane Smith', date: '2026-01-10' },
    { id: '3', type: 'Payment', amount: 230.00, status: 'Completed', customer: 'Mike Johnson', date: '2026-01-09' },
    { id: '4', type: 'Payment', amount: 89.50, status: 'Completed', customer: 'Sarah Davis', date: '2026-01-09' },
    { id: '5', type: 'Refund', amount: -120.00, status: 'Completed', customer: 'Bob Wilson', date: '2026-01-08' }
  ];
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">Monitor payments, revenue, and refunds</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-3xl font-semibold text-gray-900">${stats.pendingPayments.toLocaleString()}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-3xl font-semibold text-gray-900">${stats.completedPayments.toLocaleString()}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-3xl font-semibold text-gray-900">${stats.refundsPending.toLocaleString()}</p>
              </div>

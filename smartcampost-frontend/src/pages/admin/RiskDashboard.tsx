...
import { AlertTriangle, Shield, TrendingDown, CheckCircle2, XCircle, Clock, FileWarning } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Monitor and manage security alerts and compliance</p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-semibold text-gray-900">{stats.resolvedAlerts}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-semibold text-gray-900">{stats.complianceScore}%</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-semibold text-gray-900">{stats.fraudDetected}</p>
              </div>

-- =========================================================
-- SmartCAMPOST - COMPLETE MySQL Schema (All Migrations Applied)
-- For TiDB Cloud (MySQL 8.0 Compatible)
-- Date: 2026-03-08
-- =========================================================
-- This script CREATES the SmartCAMPOST database from scratch.
-- It includes ALL migrations (V2-V5) already merged in.
--
-- INSTRUCTIONS:
--   1. Run "CREATE DATABASE" line first
--   2. Select smartcampostDB from the TiDB Cloud dropdown
--   3. Run everything below the CREATE DATABASE line
-- =========================================================

-- =========================================================
-- STEP 1: Create database (run alone first)
-- =========================================================
CREATE DATABASE IF NOT EXISTS smartcampostDB;

-- =========================================================
-- STEP 2: Select smartcampostDB, then run everything below
-- =========================================================
...
-- =========================================================
-- 7) PARCEL (includes V4 current_latitude/longitude/location_updated_at)
-- =========================================================
CREATE TABLE IF NOT EXISTS parcel (
  ...
  -- Current location (denormalized from scan events - V4)
...
-- =========================================================
-- 8) PICKUP_REQUEST (includes V3 GPS columns)
-- =========================================================
...
-- =========================================================
-- 9) SCAN_EVENT (includes V3 offline sync columns)
-- =========================================================
...
-- =========================================================
-- 27) LOCATIONS (V5: user_id is VARCHAR(64), not BIGINT)
-- =========================================================
CREATE TABLE IF NOT EXISTS locations (
  id          BIGINT AUTO_INCREMENT NOT NULL,
  user_id     VARCHAR(64)   NULL COMMENT 'UUID string of courier or agent',
  latitude    DECIMAL(10,8) NULL,
  longitude   DECIMAL(11,8) NULL,
  address     VARCHAR(500)  NULL,
